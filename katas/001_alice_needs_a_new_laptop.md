...
```
%sql
SELECT query_id, message_type, action_name, event_attributes, message, timestamp FROM .chorus_log_events WHERE user_id='USER-eeed-43de-959d-90e6040e84f9' ORDER BY timestamp DESC
```
